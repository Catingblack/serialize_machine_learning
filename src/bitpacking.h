...
int bounded_code_get_unary_code(int8_t delta_val,
								 int8_t min_allowed,
								 int8_t max_allowed,
								 int alphabet);
...
enum 
{
	BOUNDED_BY_MIN_ONLY_NEGATIVE_FIRST = 0,
	BOUNDED_BY_MIN_ONLY_POSITIVE_FIRST = 1,
	BOUNDED_BY_MIN_MAX_NEGATIVE_FIRST  = 2,
	BOUNDED_BY_MIN_MAX_POSITIVE_FIRST  = 3,
	BOUNDED_NB,
};
