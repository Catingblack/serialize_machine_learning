...
int uniform_quant(sig_mag_data_t* buf, int buf_len, gcli_data_t* gclis, int group_size, int gtli);
int uniform_dequant(sig_mag_data_t* buf, int buf_len, gcli_data_t* gclis, int group_size, int gtli);
