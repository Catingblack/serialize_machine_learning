...
#ifndef GCLI_SIGFLAGS_H
#define GCLI_SIGFLAGS_H
...
typedef struct sig_flags_t sig_flags_t;
...
int sig_flags_write( bit_packer_t* bitstream, sig_flags_t* sig_flags, int significance_is_0);
int sig_flags_read( bit_unpacker_t* bitstream, sig_flags_t* sig_flags, int buf_len, int group_width, int significance_is_0);
