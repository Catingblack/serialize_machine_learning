...
int tco_pred_ver(gcli_data_t* gcli_buf, gcli_data_t* gcli_buf_top, int buf_len, gcli_pred_t* pred_buf, gcli_data_t* predictors, int gtli, int gtli_top, int top_trunc_method);
